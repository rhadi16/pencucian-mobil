<?php 
	...
	$html = '
		...
		<head>
			...
			<title>Laporan Pencucian Mobil</title>
			<style type="text/css">
	...
	$html .= '
		  <body>
				<main>
					<h1>LAPORAN PENCUCIAN MOBIL <br> TANGGAL '. datetimeFormat::TanggalIndo($tanggal_awal) .' - '. datetimeFormat::TanggalIndo($tanggal_akhir) .'</h1>
